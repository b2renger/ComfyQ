...
## Ambience 1
### stable_audio_3 | 60s
TrackType: Sound Effects. A small whitewashed brick room at the foot of a coastal tower: a cast-iron stove ticking as it cools, the sea heard flat and muffled through thick wall, one loose pane knocking in its frame, the short close reverberation of a low room. Continuous, no musical content, no speech, no sudden events.

## Ambience 2
### stable_audio_3 | 60s
TrackType: Sound Effects. An exposed stone path above the sea at dusk: a steady onshore wind over open ground, waves breaking a long way below with a slow irregular rhythm, a slack chain handrail clinking softly against an iron post, no enclosure and almost no reverberation. Continuous, no musical content, no speech, no sudden events.

## Ambience 3
### stable_audio_3 | 60s
TrackType: Sound Effects. The open top of a harbour light: wind moving fast past ironwork at height with a faint low whistle, gulls calling below the listener rather than above, a canvas cover snapping once against a rail, the sea very distant and continuous. Continuous, no musical content, no speech, no sudden events.
...
Static locked-off camera. Initially the cold lantern stands perfectly still, then a slow draught crosses the room and turns the fogged chimney a few degrees on its base, and it settles back to exactly where it began. Nothing else moves and the first and last frame are identical. Audio: a stove ticking as it cools, one loose pane knocking in its frame, a flat muffled sea beyond the wall, no music, no speech.

## Choice image
### ideogram_4_t2i | 1920x1088
A flat title card on a warm bone-white ground with a single thin amber rule running the full width beneath the title. Centred in the upper third, in a large humanist sans-serif in deep slate, the words: "The Lamplighter". Centred in the lower third, much smaller in the same face, the words: "Touch anywhere to begin". No imagery of any kind. All text is sharp and perfectly rendered. No other text anywhere in the image. flat graphic design card, deep slate and warm bone-white with one amber rule, wide margins, crisp humanist sans-serif, vector-clean, no texture, no photographic content, no illustration

## Music
### stable_audio_3 | 40s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, built from a hand-pumped harmonium and one plucked mandolin. The harmonium holds a single low chord while the mandolin turns a four-note figure over it without ever resolving, and the piece ends on exactly the chord it began so it loops without a seam. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.
...
Very slow dolly in. Initially all nine numbers sit in even grey light, then the warm light in the foreground strengthens and travels along the rack until only the empty fourth hook is lit and the rest fall back into shadow. The rack stays level, nothing enters or leaves frame. Audio: a stove ticking, one loose pane knocking, a flat muffled sea beyond the wall, no music, no speech.

## Music
### stable_audio_3 | 30s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, built from a hand-pumped harmonium and one plucked mandolin. The harmonium enters alone on a low sustained chord, the mandolin states its four-note figure once at eight seconds and repeats it a third higher, and the piece ends unresolved on the note it began. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.
...
## Video cut 3
### ltx_2_3_i2v | 1920x1088 | 5s
Static locked-off camera. Initially the hanging lantern is still on its cord, then the wind takes it and swings it once through a wide slow arc, and the chain it hangs from lifts and drops along its whole slack length. The camera does not move, the posts stay fixed in frame. Audio: a steady onshore wind rising briefly, a slack chain clinking against an iron post, waves a long way below, no music, no speech.

## Music
### stable_audio_3 | 30s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, built from a hand-pumped harmonium, one plucked mandolin and a bowed cello. The four-note mandolin figure carries alone at first, the cello enters underneath on a long held note at ten seconds, and the harmonium answers only at the very end without resolving. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.
...
## Video cut 3
### ltx_2_3_i2v | 1920x1088 | 8s
Slow dolly out. Initially the carried light is close and the tower is small behind it, then the light moves steadily away along the path and the camera draws back, until the light is a point at the foot of the tower and the tower fills the height of the frame. The horizon stays level, nothing enters frame. Audio: rain thinning to drizzle, a steady wind, waves below, no music, no speech.

## Music
### stable_audio_3 | 24s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, built from a hand-pumped harmonium, one plucked mandolin and a bowed cello. The four-note figure is played by mandolin and cello a fraction apart so it thickens without getting louder, the harmonium holding one unmoving chord beneath, ending unresolved. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.
...
## Video cut 2
### ltx_2_3_i2v | 1920x1088 | 4s
Static locked-off camera. Initially the repeated flames sit still across the prisms, then the whole housing turns a few degrees and every reflection travels sideways together and steadies again. The camera does not move, the framing is identical throughout. Audio: a heavy brass mechanism turning slowly, wind past ironwork, no music, no speech.

## Music
### stable_audio_3 | 24s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, built from a hand-pumped harmonium, one plucked mandolin and a bowed cello. All three arrive on the four-note figure together for the first time, play it twice, and hold the last note while the harmonium bellows run down. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.
...
## Video cut 2
### ltx_2_3_i2v | 1920x1088 | 8s
Slow dolly out. Initially the beam lies flat and still across the water, then it begins to sweep, travelling out across the dark sea and off the right of frame, and comes back around from the left as the camera draws steadily back. The rail stays level, nothing enters frame. Audio: a heavy brass mechanism turning slowly, wind past ironwork, the sea very distant, no music, no speech.

## End image
### ideogram_4_t2i | 1920x1088
A flat closing card on a deep slate ground with a single thin amber rule across the lower third. Centred above the rule, in a large humanist sans-serif in warm bone-white, the words: "It was never the same flame". No imagery of any kind. All text is sharp and perfectly rendered. No other text anywhere in the image. flat graphic design card, deep slate and warm bone-white with one amber rule, wide margins, crisp humanist sans-serif, vector-clean, no texture, no photographic content, no illustration

## Music
### stable_audio_3 | 18s
TrackType: Music. Sparse acoustic instrumental at 68 BPM in B flat major, hand-pumped harmonium alone. The four-note figure is played once slowly with the final note held, and the bellows are allowed to run down to nothing. Close-miked in a small brick room with audible bellows and finger noise. No vocals, no drums.

# NOTES | notes | end

Linear: LIBRARY → IDLE → S0 → S1 → S2 → S3 → E01. No choices, so the only two
cards are the title and the close.

The protagonist is the lantern, not a person. Hands enter frame twice and are
never followed to a face, which removes face drift across nineteen cuts and
removes the content-filter surface from the cards entirely.

Three locations, each opened on a wide shot before any close-up of it: the lamp
room (S0), the cliff path (S1, and again under rain in S2), the tower gallery
(S3 and E01). Ambience 1 runs under S0, Ambience 2 under S1 and S2, Ambience 3
under S3 and E01 — the two crossings are S1 cut 1 and S3 cut 1.

Clip lengths carry the pacing rather than the cutting: 3 s for a single beat
(a wick catching, a hook lighting), 8 s for the three shots that have to cover
distance (the approach along the path, the walk to the tower, the final sweep).

The film argues that a light is kept alive by being handed on, so the last cut
is the beam and not the lantern, and the closing line names the flame rather
