...
Backlog/superseded: Hunyuan3D 2.1, LTX 2.3 i2v, LTX audio-driven, 360 LoRA. Full detail + the cross-cutting infra state (GS viewer = BUILT, multi-output UX = PARTIAL/3D-gallery done, audio I/O = MISSING; long-job robustness = READY) is in [implementation_plan.md](implementation_plan.md) under "Target workflows".
